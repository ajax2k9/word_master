class tile {
  ...
  drawTile(){
    ...
    fill(this.c)
    rect(this.posX,this.posY,spacing-4,spacing-4,0.3*spacing)
    noFill()
    stroke(this.c2)
    strokeWeight(10)
    rect(this.posX,this.posY,spacing-30,spacing-30,0.2*spacing)
    noStroke()
    fill(this.c3)
    rect(this.posX,this.posY,spacing-60,spacing-60,0.1*spacing)
    fill(0)
